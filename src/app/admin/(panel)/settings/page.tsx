  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="glass-card mb-6 space-y-4 p-6">
        <h2 className="font-bold text-gold-600">بيانات التواصل</h2>
      ...
      <section className="glass-card mb-6 space-y-4 p-6">
        <h2 className="font-bold text-gold-600">حسابات السوشال ميديا (روابط كاملة)</h2>
        <div className="grid gap-4 sm:grid-cols-2">
          {(
            [
              ["instagram", "Instagram"],
      ...
      <section className="glass-card mb-8 space-y-4 p-6">
        <h2 className="font-bold text-gold-600">الإحصائيات (تظهر كعدادات متحركة)</h2>
